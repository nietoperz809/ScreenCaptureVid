...
import static monte.AudioFormatKeys.FrameSizeKey;
import static monte.BufferFlag.*;
...
public class AVIReader extends AVIInputStream implements MovieReader {
    ...
    public final static Format AVI = new Format(MediaTypeKey, FormatKeys.MediaType.FILE, MimeTypeKey, MIME_AVI);
